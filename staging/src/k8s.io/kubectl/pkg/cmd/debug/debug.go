...
func addDebugFlags(cmd *cobra.Command, opt *DebugOptions) {
	...
	cmd.Flags().StringVar(&opt.Profile, "profile", ProfileLegacy, i18n.T(`Debugging profile. Options are "legacy", "general", "baseline", "restricted", or "netadmin". See https://github.com/kubernetes/enhancements/tree/master/keps/sig-cli/1441-kubectl-debug`))
}
